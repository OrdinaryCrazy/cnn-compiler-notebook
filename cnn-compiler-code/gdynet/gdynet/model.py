...
class GDyNet(object):
    ...
    def build_cgcnn_layer(self, atom_fea, bond_fea, nbr_list):
        ...
        nbr_core = Dense(self.atom_fea_len)(total_fea)  # g
        nbr_filter = Dense(1)(total_fea)                # alpha
        if self.use_bn:
    ...
    def build_cgcnn_model(self):
        ...
        crys_fea = Lambda(_pooling, output_shape=_pooling_output_shape)([atom_fea, target_index_inp])
